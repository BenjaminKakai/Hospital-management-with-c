...
namespace DanpheEMR.DalLayer
{
    public class SocialServiceUnitDbContext : DbContext
    {
        ...
        public SocialServiceUnitDbContext(DbContextOptions<SocialServiceUnitDbContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PatientModel>().ToTable("PAT_Patient").HasOne<CountrySubDivisionModel>(p => p.CountrySubDivision).WithMany();
