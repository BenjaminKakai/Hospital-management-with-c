...
namespace DanpheEMR.DalLayer
{
    public class InsuranceDbContext : AuditDbContext
    {
        ...
        {
            // Configuration options can be set in Startup.cs or other places in EF Core.
            // The AuditDisabled property or its equivalent should be set as needed for the auditing library.
        }
