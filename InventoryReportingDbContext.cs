...
namespace DanpheEMR.DalLayer
{
    public class InventoryReportingDbContext : DbContext
    {
        ...
        public InventoryReportingDbContext(DbContextOptions<InventoryReportingDbContext> options) : base(options)
        {
            connStr = options.FindExtension<RelationalOptionsExtension>().ConnectionString;
        }
