...
namespace DanpheEMR.DalLayer
{
    public class GovernmentReportDbContext : DbContext
    {
        ...
        {
            this.connStr = this.Database.GetConnectionString();
        }
        ...
        public DynamicReport GovReportSummary(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsCtrUsrs = GetDatasetFromStoredProc("SP_Report_Gov_Summary", paramsList);
        ...
        public LaboratoryServices GetHaematology(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesHematology = GetDatasetFromStoredProc("SP_Report_Lab_Haematology", paramsList);
        ...
        public LaboratoryServices GetImmunology(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesImmunology = GetDatasetFromStoredProc("SP_Report_Lab_Immunology", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetBiochemistry(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesBiochemistry = GetDatasetFromStoredProc("SP_Report_Lab_Biochemistry", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetBacteriology(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesBacteriology = GetDatasetFromStoredProc("SP_Report_Lab_Bacteriology", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetCytology(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesCytology = GetDatasetFromStoredProc("SP_Report_Lab_Cytology", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetVirology(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesVirology = GetDatasetFromStoredProc("SP_Report_Lab_Virology", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetImmunohistochemistry(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesImmunohistochemistry = GetDatasetFromStoredProc("SP_Report_Lab_ImmunoHistoChemistry", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetHistology(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesHistology = GetDatasetFromStoredProc("SP_Report_Lab_Histology", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetParasitology(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesParasitology = GetDatasetFromStoredProc("SP_Report_Lab_Parasitology", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetCardiacenzymes(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesCardiacenzymes = GetDatasetFromStoredProc("SP_Report_Lab_CardiacEnzymes", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public LaboratoryServices GetHormonesendocrinology(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsLabServicesHormonesendocrinology = GetDatasetFromStoredProc("SP_Report_Lab_Hormones_Endocrinology", paramsList);
            LaboratoryServices obj = new LaboratoryServices();
        ...
        public InpatientServiceReportModel GetInpatientOutcome(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsInpatientOutcome = GetDatasetFromStoredProc("SP_Report_Gov_InpatientOutcome", paramsList);
        ...
        public InpatientMorbidityReportModel GetInpatientMorbidity(DateTime FromDate, DateTime ToDate)
        {
            ...
            DataSet dsInpatientMorbi = GetDatasetFromStoredProc("SP_Report_Gov_InpatientMorbidity", paramsList);
        ...
        private DataSet GetDatasetFromStoredProc(string storedProcName, List<SqlParameter> ipParams)
        {
            ...
            var context = new ReportingDbContext(connStr); // Use the class-level connection string
            // creates a Command 
